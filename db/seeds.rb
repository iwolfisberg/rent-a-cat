...
create_cat("Garfield", "Garfield louche un peu. Il adore manger, regarder la télé et dormir toute la journée. #{lorem_ipsum}", "Avenue de Fully 14", "1920", "Martigny", nico.id, "https://res.cloudinary.com/ddnihwuhu/image/upload/c_scale,h_500/v1558686804/vvuogohxuhbxkxbya1wb.jpg")
